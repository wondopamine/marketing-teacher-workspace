...
- **Tech stack**: React 19 + TanStack Start + Tailwind v4 + `motion/react`. The stack is locked. The choreography must be implementable inside this stack without introducing GSAP or another animation library.
...
- **Mobile**: Static fallback only. Do not spend engineering effort on mobile pinned scroll.
